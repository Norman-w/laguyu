...
class App {
    debugMode = false;
    setting={
        qpNetServerRouterUrl:'https://www.enni.group/netserver/router.aspx?'
    }
    globalData = {
        account: undefined,
        session: 'laguyu',
    ...
    define = {
        ...
        load_status_all: 'all',
        //用于测试的商品url
        test_image_url: 'http://pic.enni.group/upload/8801051065602/130x130/3c1397f3-a647-48f9-87fc-dc637f30bbff.jpg',
        //当商品没有图片的时候的代替面罩图片
